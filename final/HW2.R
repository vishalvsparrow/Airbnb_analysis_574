...
setwd('C:\\Users\\vishal\\Google Drive\\R\\ISDS_574_project\\final')
...
# Decision Tree Learning performs the best on our data, for some strange reason. But it looks beautiful :)
